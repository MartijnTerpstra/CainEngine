	...
	_In_reads_(NumSubresources) D3D12_SUBRESOURCE_DATA* pSrcData)
{
	...
	{
		d3d12Sizes.push_back(Layouts[i].Offset - Layouts[i - 1].Offset);
		d3d11Sizes.push_back(pSrcData[i].SlicePitch);
	}
	d3d12Sizes.push_back(RequiredSize - Layouts[NumSubresources - 1].Offset);
